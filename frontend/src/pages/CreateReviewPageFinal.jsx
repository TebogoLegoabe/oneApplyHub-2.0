...
const CreateReviewPageFinal = () => {
  ...
  const submitReview = async (event) => {
    ...
    setSubmitting(true);
    try {
      await reviewsAPI.createReview(id, { ...review, subject: property?.name ? `Review for ${property.name}` : 'Property Review' });
      setSuccess(true);
