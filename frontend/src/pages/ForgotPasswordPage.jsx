...
const PAGE_WRAPPER = 'min-h-screen bg-slate-50 dark:bg-gray-950 flex flex-col justify-center py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden';
...
const INPUT = 'w-full rounded-xl border border-slate-200 bg-white py-3 pl-10 pr-4 text-sm text-slate-900 outline-none transition focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 dark:border-slate-700 dark:bg-slate-950 dark:text-white';
  ...
  return (
    <div className={PAGE_WRAPPER}>
      ...
      <div className="relative z-10 mx-auto w-full max-w-md">
        <Link to="/login" className="mb-4 inline-flex items-center text-xs font-bold text-slate-500 hover:text-brand-600 dark:text-slate-400">
          ...
          <div className="p-5 sm:p-6">
            {success ? (
              <div className="text-center">
                ...
                <Link to="/login" className="mt-5 inline-flex rounded-xl bg-brand-600 px-5 py-2.5 text-sm font-bold text-white hover:bg-brand-700">
                  Back to login
                </Link>
              </div>
            ) : (
