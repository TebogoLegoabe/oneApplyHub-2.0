  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        <Link to="/" className="mb-5 inline-flex items-center rounded-xl bg-white px-3 py-2 text-xs font-bold text-brand-600 shadow-sm hover:text-brand-700 dark:bg-slate-900 dark:text-brand-300">
        ...
        <header className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-8">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-50 text-brand-600 dark:bg-brand-500/10 dark:text-brand-300">
            <FileText className="h-6 w-6" />
          </div>
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-brand-600 dark:text-brand-300">OneApplyHub legal</p>
        ...
        <div className="mt-5 rounded-3xl border border-brand-100 bg-brand-50 p-5 text-sm text-brand-900 dark:border-brand-900 dark:bg-brand-500/10 dark:text-brand-100">
          <div className="flex items-start gap-3">
            <Mail className="mt-0.5 h-4 w-4 shrink-0" />
            <p>Questions about this document? Contact <a href="mailto:info@oneapplyhub.co.za" className="font-bold underline">info@oneapplyhub.co.za</a>.</p>
          </div>
        </div>
      </div>
    </div>
