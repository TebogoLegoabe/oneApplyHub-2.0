...
const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-950">
      ...
      {/* Top bar */}
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700/60 px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        <div>
            ...
            {loading ? (
              ...
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={data.top_properties} layout="vertical" margin={{ top: 0, right: 12, left: 0, bottom: 0 }}>
                  ...
                  <XAxis
                    type="number" tick={{ fill: axisColor, fontSize: 11 }}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          {loading ? (
            <div className="p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 animate-pulse">
              {[...Array(6)].map((_, i) => <div key={i} className="h-32 bg-gray-100 dark:bg-gray-700 rounded-xl" />)}
            </div>
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0 ml-2">
                      ...
                      <span className="text-xs font-black text-gray-700 dark:text-gray-200">{review.overall_rating}</span>
                    </div>
                  </div>
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-indigo-200">
              Your review helps thousands of students make better accommodation decisions.
            </p>
          </div>
          <Link
            to="/properties"
          ...
          >
            <FileText className="w-4 h-4" />Write a Review
          </Link>
        </div>
