...
def print_database_help(exc):
    ...
    print('3. Check backend/.env has the same user, password, port, and database as docker-compose.yml.')
    print('4. For the tested Windows-safe local setup, use:')
    print('   DATABASE_URL=postgresql://oneapplyhub:<local_password>@127.0.0.1:15432/oneapplyhub_dev')
    print('5. If local Postgres was recreated, reset the local Docker volume: docker compose down -v')
